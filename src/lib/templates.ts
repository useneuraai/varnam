...
export const TEMPLATES: TemplateDefinition[] = [
  {
    slug: "thiruvizha",
    name: "THIRUVIZHA — Grand Traditional Tamil 🛕",
    description: "A grand Tamil wedding ceremony inside a sacred temple and mantapam. Dark maroon, subtle temple stone texture, carved pillars, antique gold typography, thoranam, banana leaves, and sacred Tamil chants.",
    category: "Tamil Wedding",
    religion: "Hindu",
    language: "Tamil/English",
    price: 799,
    thumbnailUrl: "/images/couples/thiruvizha.jpg",
  ...
  {
    slug: "manamagan",
    name: "MANAMAGAN — Soft Jasmine Wedding 🌸",
    description: "Two people, one love story. Soft, romantic, emotional, and dreamy. Warm ivory canvas, photographic couple hero, realistic cascading Madurai jasmine vines, delicate blush accents, and editorial photo flow.",
    category: "Tamil Wedding",
    religion: "Hindu",
    language: "Tamil/English",
    price: 799,
    thumbnailUrl: "/images/couples/manamagan.jpg",
  ...
  {
    slug: "mangalam",
    name: "MANGALAM — Temple Luxury 👑",
    description: "The ₹999+ royal luxury experience. Dramatic dark charcoal and near-black backdrop, controlled real antique gold architectural details, interactive opening temple doors on scroll, and four ceremonial chapters.",
    category: "Tamil Wedding",
    religion: "Hindu",
    language: "Tamil/English",
    price: 999,
    thumbnailUrl: "/images/couples/mangalam.jpg",
    previewMusicUrl: "https://archive.org/download/r-12356661-1632393571-2601/01.%20Raag%20Bhimpalasi%20-%20Teen%20Taal.mp3",
    fields: [
  ...
  {
    slug: "vizha",
    name: "VIZHA — Colourful Tamil Wedding 🌼",
    description: "Joyful, festive, young, and energetic Tamil wedding celebration. Warm cream canvas accented with marigold garlands, self-drawing Kolam vectors, turmeric yellow, parrot green, and rani pink silk.",
    category: "Tamil Wedding",
    religion: "Hindu",
    language: "Tamil/English",
    price: 799,
    thumbnailUrl: "/images/couples/vizha.jpg",
  ...
  {
    slug: "kadhal",
    name: "KADHAL — Modern Tamil Editorial 🖤",
    description: "Awwwards website × Vogue wedding editorial × Tamil culture. Minimal, artistic, young, sophisticated. Chalk ivory canvas, stark black typography, vermilion accents, full-screen zoom, and fashion layouts.",
    category: "Tamil Wedding",
    religion: "Secular",
    language: "English/Tamil",
    price: 799,
    thumbnailUrl: "/images/couples/kadhal.jpg",
  ...
  },
  {
    ...
    name: "Thanjavur Temple Heritage 🛕",
    description: "A magnificent South Indian temple wedding invitation. Towering colorful Dravidian temple gopuram, azure twilight sky with floating glowing paper sky lanterns, monumental serif typography, red music play button, and sacred temple mandapam.",
    category: "Tamil Wedding",
    religion: "Hindu",
    language: "Tamil/English",
    price: 799,
    thumbnailUrl: "/images/gopuram/temple_gopuram.jpg",
    previewMusicUrl: "https://archive.org/download/r-12356661-1632393571-2601/01.%20Raag%20Bhimpalasi%20-%20Teen%20Taal.mp3",
    fields: [
      { id: "bride_name", label: "Bride Name", type: "text", placeholder: "Kavya", required: true },
...
export const getTemplateBySlug = (slug: string): TemplateDefinition | undefined => {
  ...
  if (!t) {
    const legacyAliases: Record<string, string> = {
      "gopuram": "thanjavur-heritage",
      "koyil": "thanjavur-heritage",
